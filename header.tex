...
% Prefixes for self-citations: replace the `m` after \newcites with a different
% letter to use a different prefix, then update the corresponding commands at the
% end of main.tex to use the same letter (a comment at the end of main.tex 
